...
{
    public class AlightenLevelMultiTimeframeMATickPatternCV0003 : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name        = "AlightenLevelMultiTimeframeMATickPatternCV0003";
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private AlightenLevelMultiTimeframeMATickPatternCV0003[] cacheAlightenLevelMultiTimeframeMATickPatternCV0003;
		public AlightenLevelMultiTimeframeMATickPatternCV0003 AlightenLevelMultiTimeframeMATickPatternCV0003(int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return AlightenLevelMultiTimeframeMATickPatternCV0003(Input, barsToProcess, enablePatternCSignal, enablePatternCLevels, drawPatternC, patternCMarkerFontSize, patternCMarkerOffsetTicks, patternCLongColor, patternCShortColor, patternCLevelWidth, patternCLevelDashStyle, requirePivotForPatternCSignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public AlightenLevelMultiTimeframeMATickPatternCV0003 AlightenLevelMultiTimeframeMATickPatternCV0003(ISeries<double> input, int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			if (cacheAlightenLevelMultiTimeframeMATickPatternCV0003 != null)
				for (int idx = 0; idx < cacheAlightenLevelMultiTimeframeMATickPatternCV0003.Length; idx++)
					if (cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx] != null && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].BarsToProcess == barsToProcess && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].EnablePatternCSignal == enablePatternCSignal && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].EnablePatternCLevels == enablePatternCLevels && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].DrawPatternC == drawPatternC && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].PatternCMarkerFontSize == patternCMarkerFontSize && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].PatternCMarkerOffsetTicks == patternCMarkerOffsetTicks && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].PatternCLongColor == patternCLongColor && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].PatternCShortColor == patternCShortColor && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].PatternCLevelWidth == patternCLevelWidth && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].PatternCLevelDashStyle == patternCLevelDashStyle && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].RequirePivotForPatternCSignal == requirePivotForPatternCSignal && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].ShowZigZag == showZigZag && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].ZigZagColor == zigZagColor && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].ZigZagWidth == zigZagWidth && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].ZigZagStyle == zigZagStyle && cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx].EqualsInput(input))
						return cacheAlightenLevelMultiTimeframeMATickPatternCV0003[idx];
			return CacheIndicator<AlightenLevelMultiTimeframeMATickPatternCV0003>(new AlightenLevelMultiTimeframeMATickPatternCV0003(){ BarsToProcess = barsToProcess, EnablePatternCSignal = enablePatternCSignal, EnablePatternCLevels = enablePatternCLevels, DrawPatternC = drawPatternC, PatternCMarkerFontSize = patternCMarkerFontSize, PatternCMarkerOffsetTicks = patternCMarkerOffsetTicks, PatternCLongColor = patternCLongColor, PatternCShortColor = patternCShortColor, PatternCLevelWidth = patternCLevelWidth, PatternCLevelDashStyle = patternCLevelDashStyle, RequirePivotForPatternCSignal = requirePivotForPatternCSignal, ShowZigZag = showZigZag, ZigZagColor = zigZagColor, ZigZagWidth = zigZagWidth, ZigZagStyle = zigZagStyle }, input, ref cacheAlightenLevelMultiTimeframeMATickPatternCV0003);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.AlightenLevelMultiTimeframeMATickPatternCV0003 AlightenLevelMultiTimeframeMATickPatternCV0003(int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternCV0003(Input, barsToProcess, enablePatternCSignal, enablePatternCLevels, drawPatternC, patternCMarkerFontSize, patternCMarkerOffsetTicks, patternCLongColor, patternCShortColor, patternCLevelWidth, patternCLevelDashStyle, requirePivotForPatternCSignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public Indicators.AlightenLevelMultiTimeframeMATickPatternCV0003 AlightenLevelMultiTimeframeMATickPatternCV0003(ISeries<double> input , int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternCV0003(input, barsToProcess, enablePatternCSignal, enablePatternCLevels, drawPatternC, patternCMarkerFontSize, patternCMarkerOffsetTicks, patternCLongColor, patternCShortColor, patternCLevelWidth, patternCLevelDashStyle, requirePivotForPatternCSignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}
	}
