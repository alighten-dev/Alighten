...
{
    public class AlightenLevelMultiTimeframeMATickPatternAV0002 : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name        = "AlightenLevelMultiTimeframeMATickPatternAV0002";
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private AlightenLevelMultiTimeframeMATickPatternAV0002[] cacheAlightenLevelMultiTimeframeMATickPatternAV0002;
		public AlightenLevelMultiTimeframeMATickPatternAV0002 AlightenLevelMultiTimeframeMATickPatternAV0002(int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return AlightenLevelMultiTimeframeMATickPatternAV0002(Input, barsToProcess, enablePatternASignal, enablePatternALevels, drawPatternA, patternAMarkerFontSize, patternAMarkerOffsetTicks, patternALongColor, patternAShortColor, patternALevelWidth, patternALevelDashStyle, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public AlightenLevelMultiTimeframeMATickPatternAV0002 AlightenLevelMultiTimeframeMATickPatternAV0002(ISeries<double> input, int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			if (cacheAlightenLevelMultiTimeframeMATickPatternAV0002 != null)
				for (int idx = 0; idx < cacheAlightenLevelMultiTimeframeMATickPatternAV0002.Length; idx++)
					if (cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx] != null && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].BarsToProcess == barsToProcess && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].EnablePatternASignal == enablePatternASignal && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].EnablePatternALevels == enablePatternALevels && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].DrawPatternA == drawPatternA && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].PatternAMarkerFontSize == patternAMarkerFontSize && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].PatternAMarkerOffsetTicks == patternAMarkerOffsetTicks && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].PatternALongColor == patternALongColor && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].PatternAShortColor == patternAShortColor && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].PatternALevelWidth == patternALevelWidth && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].PatternALevelDashStyle == patternALevelDashStyle && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].ShowZigZag == showZigZag && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].ZigZagColor == zigZagColor && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].ZigZagWidth == zigZagWidth && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].ZigZagStyle == zigZagStyle && cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx].EqualsInput(input))
						return cacheAlightenLevelMultiTimeframeMATickPatternAV0002[idx];
			return CacheIndicator<AlightenLevelMultiTimeframeMATickPatternAV0002>(new AlightenLevelMultiTimeframeMATickPatternAV0002(){ BarsToProcess = barsToProcess, EnablePatternASignal = enablePatternASignal, EnablePatternALevels = enablePatternALevels, DrawPatternA = drawPatternA, PatternAMarkerFontSize = patternAMarkerFontSize, PatternAMarkerOffsetTicks = patternAMarkerOffsetTicks, PatternALongColor = patternALongColor, PatternAShortColor = patternAShortColor, PatternALevelWidth = patternALevelWidth, PatternALevelDashStyle = patternALevelDashStyle, ShowZigZag = showZigZag, ZigZagColor = zigZagColor, ZigZagWidth = zigZagWidth, ZigZagStyle = zigZagStyle }, input, ref cacheAlightenLevelMultiTimeframeMATickPatternAV0002);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.AlightenLevelMultiTimeframeMATickPatternAV0002 AlightenLevelMultiTimeframeMATickPatternAV0002(int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternAV0002(Input, barsToProcess, enablePatternASignal, enablePatternALevels, drawPatternA, patternAMarkerFontSize, patternAMarkerOffsetTicks, patternALongColor, patternAShortColor, patternALevelWidth, patternALevelDashStyle, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public Indicators.AlightenLevelMultiTimeframeMATickPatternAV0002 AlightenLevelMultiTimeframeMATickPatternAV0002(ISeries<double> input , int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternAV0002(input, barsToProcess, enablePatternASignal, enablePatternALevels, drawPatternA, patternAMarkerFontSize, patternAMarkerOffsetTicks, patternALongColor, patternAShortColor, patternALevelWidth, patternALevelDashStyle, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}
	}
