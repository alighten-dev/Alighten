...
namespace NinjaTrader.NinjaScript.Indicators
{
    ...
    // Pattern A (V0011)
    //
    // V0011 (2026-09-15) — CLOSED-BAR LEVEL PUBLISHING FIX
    //   Copied from V0010. V0010 wrote patternALongLevel[1] / patternAShortLevel[1]
    ...
    //   from patternALevels, a path the Mirror never reads.
    //   Each direction now publishes independently. patternASignal is unchanged and
    //   still reports 0 on an ambiguous bar.
    //
    //   Same defect and fix as PtG V0003 (diagnosed 2026-09-14 on a G15S+J15S zone
    //   at 29558.75), PtF V0004 and PtH V0003. PtB is unaffected (it never writes
    ...
    // =====================================================================
    public class AlightenMirrorPtAV0011 : Indicator
    {
		        ...
		        if (allowHeavy)
		        {
		            ...
		            if (EnablePatternASignal)
		            {
		                ...
		                if (CurrentBars[0] >= 1)
		                {
		                    ...
		                    // ------------------------------------------------------------------
		                    // V0011 FIX (same defect fixed in PtG V0003): publish each direction's
		                    // LEVEL independently. patternALongLevel and patternAShortLevel are
		                    ...
		                    // patternALevels, a path the Mirror never reads.
		                    //
		                    ...
		                    // ------------------------------------------------------------------
		                    if (longNow && patternALongLevelByBar != null
		                        && patternALongLevelByBar.TryGetValue(sigBar, out double lvlPriceLong))
		                        patternALongLevel[1] = lvlPriceLong;

		                    if (shortNow && patternAShortLevelByBar != null
		                        && patternAShortLevelByBar.TryGetValue(sigBar, out double lvlPriceShort))
		                        patternAShortLevel[1] = lvlPriceShort;

		                    // patternASignal keeps its single-direction semantics UNCHANGED for
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private AlightenMirrorPtAV0011[] cacheAlightenMirrorPtAV0011;
		public AlightenMirrorPtAV0011 AlightenMirrorPtAV0011(int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showDebugLabels, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return AlightenMirrorPtAV0011(Input, barsToProcess, enablePatternASignal, enablePatternALevels, drawPatternA, patternAMarkerFontSize, patternAMarkerOffsetTicks, patternALongColor, patternAShortColor, patternALevelWidth, patternALevelDashStyle, showDebugLabels, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public AlightenMirrorPtAV0011 AlightenMirrorPtAV0011(ISeries<double> input, int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showDebugLabels, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			if (cacheAlightenMirrorPtAV0011 != null)
				for (int idx = 0; idx < cacheAlightenMirrorPtAV0011.Length; idx++)
					if (cacheAlightenMirrorPtAV0011[idx] != null && cacheAlightenMirrorPtAV0011[idx].BarsToProcess == barsToProcess && cacheAlightenMirrorPtAV0011[idx].EnablePatternASignal == enablePatternASignal && cacheAlightenMirrorPtAV0011[idx].EnablePatternALevels == enablePatternALevels && cacheAlightenMirrorPtAV0011[idx].DrawPatternA == drawPatternA && cacheAlightenMirrorPtAV0011[idx].PatternAMarkerFontSize == patternAMarkerFontSize && cacheAlightenMirrorPtAV0011[idx].PatternAMarkerOffsetTicks == patternAMarkerOffsetTicks && cacheAlightenMirrorPtAV0011[idx].PatternALongColor == patternALongColor && cacheAlightenMirrorPtAV0011[idx].PatternAShortColor == patternAShortColor && cacheAlightenMirrorPtAV0011[idx].PatternALevelWidth == patternALevelWidth && cacheAlightenMirrorPtAV0011[idx].PatternALevelDashStyle == patternALevelDashStyle && cacheAlightenMirrorPtAV0011[idx].ShowDebugLabels == showDebugLabels && cacheAlightenMirrorPtAV0011[idx].ShowZigZag == showZigZag && cacheAlightenMirrorPtAV0011[idx].ZigZagColor == zigZagColor && cacheAlightenMirrorPtAV0011[idx].ZigZagWidth == zigZagWidth && cacheAlightenMirrorPtAV0011[idx].ZigZagStyle == zigZagStyle && cacheAlightenMirrorPtAV0011[idx].EqualsInput(input))
						return cacheAlightenMirrorPtAV0011[idx];
			return CacheIndicator<AlightenMirrorPtAV0011>(new AlightenMirrorPtAV0011(){ BarsToProcess = barsToProcess, EnablePatternASignal = enablePatternASignal, EnablePatternALevels = enablePatternALevels, DrawPatternA = drawPatternA, PatternAMarkerFontSize = patternAMarkerFontSize, PatternAMarkerOffsetTicks = patternAMarkerOffsetTicks, PatternALongColor = patternALongColor, PatternAShortColor = patternAShortColor, PatternALevelWidth = patternALevelWidth, PatternALevelDashStyle = patternALevelDashStyle, ShowDebugLabels = showDebugLabels, ShowZigZag = showZigZag, ZigZagColor = zigZagColor, ZigZagWidth = zigZagWidth, ZigZagStyle = zigZagStyle }, input, ref cacheAlightenMirrorPtAV0011);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.AlightenMirrorPtAV0011 AlightenMirrorPtAV0011(int barsToProcess, bool enablePatternASignal, bool enablePatternALevels, bool drawPatternA, int patternAMarkerFontSize, int patternAMarkerOffsetTicks, System.Windows.Media.Brush patternALongColor, System.Windows.Media.Brush patternAShortColor, int patternALevelWidth, DashStyleHelper patternALevelDashStyle, bool showDebugLabels, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
