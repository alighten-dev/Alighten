...
{
    public class AlightenLevelMultiTimeframeMATickPatternEV0004 : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name        = "AlightenLevelMultiTimeframeMATickPatternEV0004";
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private AlightenLevelMultiTimeframeMATickPatternEV0004[] cacheAlightenLevelMultiTimeframeMATickPatternEV0004;
		public AlightenLevelMultiTimeframeMATickPatternEV0004 AlightenLevelMultiTimeframeMATickPatternEV0004(int barsToProcess, bool enablePatternESignal, bool enablePatternELevels, bool drawPatternE, int patternEMarkerFontSize, int patternEMarkerOffsetTicks, System.Windows.Media.Brush patternELongColor, System.Windows.Media.Brush patternEShortColor, int patternELevelWidth, DashStyleHelper patternELevelDashStyle, bool requirePivotForPatternESignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return AlightenLevelMultiTimeframeMATickPatternEV0004(Input, barsToProcess, enablePatternESignal, enablePatternELevels, drawPatternE, patternEMarkerFontSize, patternEMarkerOffsetTicks, patternELongColor, patternEShortColor, patternELevelWidth, patternELevelDashStyle, requirePivotForPatternESignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public AlightenLevelMultiTimeframeMATickPatternEV0004 AlightenLevelMultiTimeframeMATickPatternEV0004(ISeries<double> input, int barsToProcess, bool enablePatternESignal, bool enablePatternELevels, bool drawPatternE, int patternEMarkerFontSize, int patternEMarkerOffsetTicks, System.Windows.Media.Brush patternELongColor, System.Windows.Media.Brush patternEShortColor, int patternELevelWidth, DashStyleHelper patternELevelDashStyle, bool requirePivotForPatternESignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			if (cacheAlightenLevelMultiTimeframeMATickPatternEV0004 != null)
				for (int idx = 0; idx < cacheAlightenLevelMultiTimeframeMATickPatternEV0004.Length; idx++)
					if (cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx] != null && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].BarsToProcess == barsToProcess && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].EnablePatternESignal == enablePatternESignal && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].EnablePatternELevels == enablePatternELevels && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].DrawPatternE == drawPatternE && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].PatternEMarkerFontSize == patternEMarkerFontSize && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].PatternEMarkerOffsetTicks == patternEMarkerOffsetTicks && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].PatternELongColor == patternELongColor && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].PatternEShortColor == patternEShortColor && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].PatternELevelWidth == patternELevelWidth && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].PatternELevelDashStyle == patternELevelDashStyle && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].RequirePivotForPatternESignal == requirePivotForPatternESignal && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].ShowZigZag == showZigZag && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].ZigZagColor == zigZagColor && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].ZigZagWidth == zigZagWidth && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].ZigZagStyle == zigZagStyle && cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx].EqualsInput(input))
						return cacheAlightenLevelMultiTimeframeMATickPatternEV0004[idx];
			return CacheIndicator<AlightenLevelMultiTimeframeMATickPatternEV0004>(new AlightenLevelMultiTimeframeMATickPatternEV0004(){ BarsToProcess = barsToProcess, EnablePatternESignal = enablePatternESignal, EnablePatternELevels = enablePatternELevels, DrawPatternE = drawPatternE, PatternEMarkerFontSize = patternEMarkerFontSize, PatternEMarkerOffsetTicks = patternEMarkerOffsetTicks, PatternELongColor = patternELongColor, PatternEShortColor = patternEShortColor, PatternELevelWidth = patternELevelWidth, PatternELevelDashStyle = patternELevelDashStyle, RequirePivotForPatternESignal = requirePivotForPatternESignal, ShowZigZag = showZigZag, ZigZagColor = zigZagColor, ZigZagWidth = zigZagWidth, ZigZagStyle = zigZagStyle }, input, ref cacheAlightenLevelMultiTimeframeMATickPatternEV0004);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.AlightenLevelMultiTimeframeMATickPatternEV0004 AlightenLevelMultiTimeframeMATickPatternEV0004(int barsToProcess, bool enablePatternESignal, bool enablePatternELevels, bool drawPatternE, int patternEMarkerFontSize, int patternEMarkerOffsetTicks, System.Windows.Media.Brush patternELongColor, System.Windows.Media.Brush patternEShortColor, int patternELevelWidth, DashStyleHelper patternELevelDashStyle, bool requirePivotForPatternESignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternEV0004(Input, barsToProcess, enablePatternESignal, enablePatternELevels, drawPatternE, patternEMarkerFontSize, patternEMarkerOffsetTicks, patternELongColor, patternEShortColor, patternELevelWidth, patternELevelDashStyle, requirePivotForPatternESignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public Indicators.AlightenLevelMultiTimeframeMATickPatternEV0004 AlightenLevelMultiTimeframeMATickPatternEV0004(ISeries<double> input , int barsToProcess, bool enablePatternESignal, bool enablePatternELevels, bool drawPatternE, int patternEMarkerFontSize, int patternEMarkerOffsetTicks, System.Windows.Media.Brush patternELongColor, System.Windows.Media.Brush patternEShortColor, int patternELevelWidth, DashStyleHelper patternELevelDashStyle, bool requirePivotForPatternESignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternEV0004(input, barsToProcess, enablePatternESignal, enablePatternELevels, drawPatternE, patternEMarkerFontSize, patternEMarkerOffsetTicks, patternELongColor, patternEShortColor, patternELevelWidth, patternELevelDashStyle, requirePivotForPatternESignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}
	}
