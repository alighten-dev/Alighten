...
{
    public class AlightenLevelMultiTimeframeMATickPatternCV0002 : Indicator
    {
		...
		// Pattern C structure tracking (triplets/pivots). This mirrors the V00029 concept.
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name        = "AlightenLevelMultiTimeframeMATickPatternCV0002";
		...
		private void UpdatePatternC_Live_BIP0()
		{
		    ...
		    foreach (var cand in patternCCandidates)
		    {
				...
				int lastEvalBar   = CurrentBar; // include current bar for eligibility scan only
		...
		//                double c = Close[barsAgo];
		        ...
		        */
		        ...
		        // Choose "best" live candidate per side (same as your old method)
		        ...
		        if (cand.IsLong)
		        {
		            if (distTicks < bestLongDistTicks)
		            {
		                ...
		                bestLongOg         = og;
		                bestLongOgPivotIdx = cand.OgPivotIdx;
		                liveLong           = true;
		            }
		        }
		        else
		        {
		            if (distTicks < bestShortDistTicks)
		            {
		                ...
		                bestShortOg         = og;
		                bestShortOgPivotIdx = cand.OgPivotIdx;
		                liveShort           = true;
		            }
		        }
		    }
		    ...
		    else if (liveLong && liveShort)
		    {
		        ...
		        else
		        {
		            ...
		            if (!double.IsNaN(bestLongOg))
		                longPen = (bestLongOg - l0) / TickSize;
		
		            if (!double.IsNaN(bestShortOg))
		                shortPen = (h0 - bestShortOg) / TickSize;
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private AlightenLevelMultiTimeframeMATickPatternCV0002[] cacheAlightenLevelMultiTimeframeMATickPatternCV0002;
		public AlightenLevelMultiTimeframeMATickPatternCV0002 AlightenLevelMultiTimeframeMATickPatternCV0002(int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return AlightenLevelMultiTimeframeMATickPatternCV0002(Input, barsToProcess, enablePatternCSignal, enablePatternCLevels, drawPatternC, patternCMarkerFontSize, patternCMarkerOffsetTicks, patternCLongColor, patternCShortColor, patternCLevelWidth, patternCLevelDashStyle, requirePivotForPatternCSignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}

		public AlightenLevelMultiTimeframeMATickPatternCV0002 AlightenLevelMultiTimeframeMATickPatternCV0002(ISeries<double> input, int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			if (cacheAlightenLevelMultiTimeframeMATickPatternCV0002 != null)
				for (int idx = 0; idx < cacheAlightenLevelMultiTimeframeMATickPatternCV0002.Length; idx++)
					if (cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx] != null && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].BarsToProcess == barsToProcess && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].EnablePatternCSignal == enablePatternCSignal && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].EnablePatternCLevels == enablePatternCLevels && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].DrawPatternC == drawPatternC && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].PatternCMarkerFontSize == patternCMarkerFontSize && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].PatternCMarkerOffsetTicks == patternCMarkerOffsetTicks && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].PatternCLongColor == patternCLongColor && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].PatternCShortColor == patternCShortColor && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].PatternCLevelWidth == patternCLevelWidth && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].PatternCLevelDashStyle == patternCLevelDashStyle && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].RequirePivotForPatternCSignal == requirePivotForPatternCSignal && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].ShowZigZag == showZigZag && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].ZigZagColor == zigZagColor && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].ZigZagWidth == zigZagWidth && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].ZigZagStyle == zigZagStyle && cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx].EqualsInput(input))
						return cacheAlightenLevelMultiTimeframeMATickPatternCV0002[idx];
			return CacheIndicator<AlightenLevelMultiTimeframeMATickPatternCV0002>(new AlightenLevelMultiTimeframeMATickPatternCV0002(){ BarsToProcess = barsToProcess, EnablePatternCSignal = enablePatternCSignal, EnablePatternCLevels = enablePatternCLevels, DrawPatternC = drawPatternC, PatternCMarkerFontSize = patternCMarkerFontSize, PatternCMarkerOffsetTicks = patternCMarkerOffsetTicks, PatternCLongColor = patternCLongColor, PatternCShortColor = patternCShortColor, PatternCLevelWidth = patternCLevelWidth, PatternCLevelDashStyle = patternCLevelDashStyle, RequirePivotForPatternCSignal = requirePivotForPatternCSignal, ShowZigZag = showZigZag, ZigZagColor = zigZagColor, ZigZagWidth = zigZagWidth, ZigZagStyle = zigZagStyle }, input, ref cacheAlightenLevelMultiTimeframeMATickPatternCV0002);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.AlightenLevelMultiTimeframeMATickPatternCV0002 AlightenLevelMultiTimeframeMATickPatternCV0002(int barsToProcess, bool enablePatternCSignal, bool enablePatternCLevels, bool drawPatternC, int patternCMarkerFontSize, int patternCMarkerOffsetTicks, System.Windows.Media.Brush patternCLongColor, System.Windows.Media.Brush patternCShortColor, int patternCLevelWidth, DashStyleHelper patternCLevelDashStyle, bool requirePivotForPatternCSignal, bool showZigZag, System.Windows.Media.Brush zigZagColor, int zigZagWidth, DashStyleHelper zigZagStyle)
		{
			return indicator.AlightenLevelMultiTimeframeMATickPatternCV0002(Input, barsToProcess, enablePatternCSignal, enablePatternCLevels, drawPatternC, patternCMarkerFontSize, patternCMarkerOffsetTicks, patternCLongColor, patternCShortColor, patternCLevelWidth, patternCLevelDashStyle, requirePivotForPatternCSignal, showZigZag, zigZagColor, zigZagWidth, zigZagStyle);
		}
